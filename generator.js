...
var company = ["Facebook", "FarmVille", "Reddit", "Twitter", "Yelp", "Instagram", "Fandango", "eBay", "Amazon", "Spotify", "Tumblr", "a meme generator", "Netflix", "Wordpress", "Pinterest", "Groupon", "Flickr", "LiveJournal", "Hot Or Not", "Pets.com", "Angry Birds", "Foursquare", "StubHub", "GitHub", "MySpace", "SoundCloud", "Pitchfork", "Buzzfeed", "Wikipedia", "LinkedIn", "Chatroulette", "a 1990s Lycos chatroom", "Google Reader", "OKCupid", "Craigslist", "Coursera", "Grindr", "HackerNews", "Epicurious", "StumbleUpon"];
var customer = ["Justin Bieber fans", "cougars", "hipsters", "yoga", "single dads", "musicians", "dogs", "clowns", "street performers", "hookups", "stoners", "web developers", "overachievers", "cops", "tiger moms", "soccer moms", "Millennials", "urban professionals", "Baby Boomers", "Republicans", "preppies", "flashmobs", "DJs", "veterans", "the elderly", "progressives", "college students", "newlyweds", "sneakerheads", "vinyl snobs", "investment bankers", "evangelicals", "freelance writers", "Kennedy assassination conspiracy theorists", "movie lovers", "foodies", "fans of The West Wing", "eccentric billionaires", "CEOs", "trees"];
